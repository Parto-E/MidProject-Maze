...
int main(void){
   ...
   trail.push_back(maze[curX][curY]);
      ...
      while(trail.empty()==false) { // stay in here till display
         // if we did not reach all cells do the following:
         if(visittedcells < ROWS*COLS){
         ...
         if(!live.empty()) {
            ...
            switch(live[rand() % live.size()]) {
               ...
               case 0:
                  ...
                  trail.push_back(maze[curX][curY - 1]);
                  break;
               //SOUTH
               case 1:
                  maze[curX][curY].removeWall(Cell::WALL_SOUTH);
               ...
               case 2:
                  ...
                  trail.push_back(maze[curX + 1][curY]);
                  break;
               //WEST
               case 3:
                  maze[curX][curY].removeWall(Cell::WALL_WEST);
